...
/**
 * Custom field for handling item ordering in Fixassets component
 *
 * @since  1.0.0
 */
class OrderingField extends FormField
{
    ...
    {
        $options = [
            HTMLHelper::_('select.option', 'asc', Text::_('COM_FIXASSETS_ORDERING_ASC')),
            HTMLHelper::_('select.option', 'desc', Text::_('COM_FIXASSETS_ORDERING_DESC'))
        ];
