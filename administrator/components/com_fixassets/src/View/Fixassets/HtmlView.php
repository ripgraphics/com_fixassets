...
namespace RipGraphics\Component\Fixassets\Administrator\View\Fixassets;
...
/**
 * Fixassets view class for Fixassets component
 *
 * @since  1.0.0
 */
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        $wa->useStyle('com_fixassets.admin')
           ->useScript('com_fixassets.admin.fixassets');
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_FIXASSETS_FIXASSETS'), 'fixassets');
