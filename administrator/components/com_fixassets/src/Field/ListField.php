...
/**
 * Custom field for handling list selection in Fixassets component
 *
 * @since  1.0.0
 */
class ListField extends FormField
{
    ...
    {
        $options = [
            HTMLHelper::_('select.option', 'option1', Text::_('COM_FIXASSETS_OPTION1')),
            HTMLHelper::_('select.option', 'option2', Text::_('COM_FIXASSETS_OPTION2'))
        ];
